...
makedocs(;
    modules=[RemoteSensingToolbox, RemoteSensingToolbox.Sensors, RemoteSensingToolbox.Spectral, RemoteSensingToolbox.Transformations, RemoteSensingToolbox.Utils],
